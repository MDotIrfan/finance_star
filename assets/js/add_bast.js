...
function addRow1(jsonData = null) {
	...
	let tr = `
    <tr>
    <td><input type="text" id="jobdesc" name="jobdesc[]" value="${jsonData?.jobdesc1 ? jsonData.jobdesc1 : ''}"></td>
    <td><input type="text" class="volume${index}" name="volume[]" value="${jsonData?.number_word ? jsonData.number_word : ''}" oninput="" id=""></td>
...
function addRow2(jsonData = null) {
    ...
    <td><input type="text" class="volume${index}" name="volume[]" value="${jsonData?.volume ? jsonData.volume : ''}" oninput="" id=""></td>
    <td><select class="custom-select lg mb-3 col-lg" aria-label=".form-select-lg example" id="unit" name="unit[]">
...
function addRow3(jsonData = null) {
	...
	let tr = `
    <tr>
    <td><input type="text" id="jobdesc" name="jobdesc[]" value="${jsonData?.jobdesc3 ? jsonData.jobdesc3 : ''}"></td>
    <td><input type="text" class="volume${index}" name="volume[]" value="${jsonData?.qtt_word ? jsonData.qtt_word : ''}" oninput="" id=""></td>
    <td><select class="custom-select lg mb-3 col-lg" aria-label=".form-select-lg example" id="unit" name="unit[]">
...
function addRow4(jsonData = null) {
	...
	let tr = `
    <tr>
    <td><input type="text" id="jobdesc" name="jobdesc[]" value="${jsonData?.jobdesc4 ? jsonData.jobdesc4 : ''}"></td>
    <td><input type="text" class="volume${index}" name="volume[]" value="${jsonData?.star_number ? jsonData.star_number : ''}" oninput="" id=""></td>
    <td><select class="custom-select lg mb-3 col-lg" aria-label=".form-select-lg example" id="unit" name="unit[]">
...
function addRow5(jsonData = null) {
    ...
    <td><input type="text" class="volume${index}" name="volume[]" value="1" oninput="" id=""></td>
    <td><select class="custom-select lg mb-3 col-lg" aria-label=".form-select-lg example" id="unit" name="unit[]">
