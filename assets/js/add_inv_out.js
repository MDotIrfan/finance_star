...
<td><input type="text" id="proman" name="proman[]" value="${jsonData?.nama_Pm ? jsonData.nama_Pm : ''}" ></td>
<td><input type="text" id="starnum" name="starnum[]" value="" ></td>
<td><input type="text" class="volume${index}" name="volume[]" value="${jsonData?.locked ? parseInt(jsonData.wwc1)+parseInt(jsonData.wwc2)+parseInt(jsonData.wwc3)+parseInt(jsonData.wwc4)+parseInt(jsonData.wwc5)+parseInt(jsonData.wwc6)+parseInt(jsonData.wwc7)+parseInt(jsonData.wwc8) : ''}" oninput="hitung(${index})" id=""></td>
<td><input type="text" class="price${index}" name="price[]" oninput="hitung(${index})" value="${jsonData?.rate ? jsonData.rate : ''}"></td>
...
function addRow_luar2(jsonData = null) {
    ...
    <td><input type="text" class="price${index}" name="price[]" oninput="hitung(${index})" value="${jsonData?.rate? jsonData.rate : ''}" >
    </td>
    <td>
...
function addRow_spq2(jsonData = null) {
    ...
    <td><input type="date" class="form-control form-control-user" name="deliv[]" value="${my_var}"></td>
