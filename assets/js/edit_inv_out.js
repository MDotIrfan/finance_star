...
function addRow_local(jsonData = null) {
	...
	let tr = `
    <tr>
    <td><input type="text" id="jobdesc" name="jobdesc[]" value="${jsonData?.domain ? jsonData.domain : ''}"></td>
...
<td><input type="text" id="proman" name="proman[]" value="${jsonData?.project_manager ? jsonData.project_manager : ''}" ></td>
<td><input type="text" id="starnum" name="starnum[]" value="${jsonData?.star_number ? jsonData.star_number : ''}" > ></td>
<td><input type="text" class="volume${index}" name="volume[]" value="${jsonData?.number_word ? jsonData.number_word : ''}" oninput="hitung(${index})" id=""></td>
<td><input type="text" class="price${index}" name="price[]" oninput="hitung(${index})" value="${jsonData?.unit_price ? jsonData.unit_price : ''}"></td>
<td><input type="text" class="cost${index}" name="cost[]" value="${jsonData?.amount ? jsonData.amount : ''}" readonly></td>
<td>
...
function addRow_spq(jsonData = null) {
  ...
  <td><input type="text" class="price${index}" name="price[]" oninput="hitung(${index})" value="${jsonData?.price ? jsonData.price : ''}"></td>
  <td><input type="text" class="cost${index}" name="cost[]" value="${jsonData?.grand_Total ? jsonData.amount : ''}" readonly></td>
  <td>
...
function addRow_luar2(jsonData = null) {
    ...
    <tr>
    <td><input type="text" id="jobdesc" name="jobdesc[]" value="${jsonData?.jobdesc ? jsonData.jobdesc : ''}"></td>
    <td><input type="text" class="volume${index}" name="volume[]" value="${jsonData?.star_number ? jsonData.star_number : ''}" oninput="hitung(${index})" id=""></td>
    <td><select class="custom-select lg mb-3 col-lg" aria-label=".form-select-lg example" id="unit" name="unit[]">
...
function addRow_spq2(jsonData = null) {
	...
	let tr = `
    <tr>
    <td><input type="text" id="jobdesc" name="jobdesc[]" value="${jsonData?.pre_invoice ? jsonData.pre_invoice : ''}"></td>
    <td><input type="date" class="form-control form-control-user" name="deliv[]" value="${jsonData?.date_deliv ? jsonData.date_deliv : ''}"></td>
    <td><input type="text" class="price${index}" name="price[]" oninput="hitung2(${index})" value="${jsonData?.grand_Total ? jsonData.grand_Total : ''}" >
    </td>
    <td>
