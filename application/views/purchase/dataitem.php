    ...
    <div class="col-lg-12">
        <div class="table-responsive">
            <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-3" style="width: auto;">
                ...
                <a style="margin-right: 20px;" href="<?php echo base_url('purchase/additem'); ?>"><button type="submit button" class="btn btn-success btn-add" style="background: #E00000;">New Purchase Order</button></a>
            </div>
...
<script type="text/javascript">
    ...
    "lengthMenu": '<select class="data-table-dropdown">'+
      ...
      "next": ">"
            ...
            "ajax": {
                "url": "<?php echo site_url('purchase/get_data_po/purchase_order_item')?>",
                "type": "POST"
            },
