    ...
    <div>
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <h1 style="text-align:right;" class="bold">PURCHASE ORDER</h1>
                </td>
            </tr>
    ...
    <div>
            ...
            <tr>
                ...
                <td>
                    <p class="bold">
                        ...
                        Indonesia<br>
                        <br>
                        Tel : +62 274-623-971<br>+62 81 333 933 132 <br>
        ...
        <div>
            <?php foreach ($p as $p) { ?>
                <table border="1" style="width: 70%" class="table" cellspacing="0" cellpadding="0" align="left">
                    ...
                    <tr>
                        <td style="text-align:center; background-color:#2eff2e" class="bold" width="35%"><a>Project Name</a></td>
            ...
            <table border="1" style="width: 25%" class="table" cellspacing="0" cellpadding="0" align="right">
                ...
                <tr>
                    <td style="text-align:center; background-color:#2eff2e" class="bold" width="%">Date Issued</td>
        ...
        <div style="margin-top: 60px;">
            <table border="1" style="width: 98.5%" class="table" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td style="text-align:center; background-color:#2eff2e" class="bold" width="50%">Project Manager</td>
                    <td width="50%" style="text-align:center; background-color:#2eff2e" class="bold">Email</td>
        ...
        <table border="1" style="width: 98.5%" class="table" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td style="text-align:center; background-color:#2eff2e" class="bold" width="35%">Freelance</td>
                <td width="35%" style="text-align:center; background-color:#2eff2e" class="bold">Email</td>
            ...
            <tr>
                <td style="text-align:center; background-color:#2eff2e" class="bold" width="35%">Mobile Phone</td>
                <td width="35%" style="text-align:center; background-color:#2eff2e" class="bold">Address</td>
            </tr>
            <tr>
        ...
        <table border="1" style="width: 100%" class="table" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td style="text-align:center; background-color:#2eff2e" class="bold" width="25%">Match</td>
                <td width="25%" style="text-align:center; background-color:#2eff2e" class="bold">Word Count</td>
                <td style="text-align:center; background-color:#2eff2e" class="bold" width="25%">Weighting</td>
                <td style="text-align:center; background-color:#2eff2e" class="bold" width="25%">Weight Word Count</td>
            </tr>
        ...
        <table border="1" style="width: 50%" align="right" cellspacing="0" cellpadding="0">
            <td width="25%" style="text-align:center; background-color:#2eff2e" class="bold">Rate</td>
            ...
            <td width="25%" style="text-align:center; background-color:#2eff2e" class="bold">Total Fee</td>
            <td width="25%" style="text-align:center;" class="bold">
                <?php if ($p->currency_po == 'IDR') {
