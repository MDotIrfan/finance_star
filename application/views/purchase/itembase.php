<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb" style="width:fit-content">
        <ol class="breadcrumb breadcrumb-dot" style="font-size: 14px;background:transparent;">
            ...
            <li class="breadcrumb-item active" aria-current="page" style="color:black;">Add Item Base</li>
        </ol>
    </nav>
        ...
        <div class=" justify-content-start" style="font-size: 18px; color:#222B45;">
            <div class="row ">
                ...
                <div class="col">
                    ...
                    <input type="" style="color:black;" class="form-control form-control-user" id="rn" name="rn" aria-describedby="" placeholder="">
                </div>
                <div class="col">
                    <label for="ps">Mobile Phone</label>
                    <input type="" style="color:black;" class="form-control form-control-user" id="pm" name="pm" aria-describedby="" placeholder="">
                </div>
                <div class="col">
        ...
        <div class=" justify-content-start" style="font-size: 18px; color:#222B45;">
            <div class="row">
                ...
                <div class="col">
                    ...
                    <input type="" style="color:black;" class="form-control form-control-user" id="ps" name="ps" aria-describedby="" placeholder="">
                </div>
                <div class="col">
                    <label for="dd">Date </label>
                    <input type="date" style="color:black;" class="form-control form-control-user" name="tgl" value="<?php $this->load->helper('date');
        ...
        <div class=" justify-content-start" style="font-size: 18px; color:#222B45;">
            <div class="row">
                <div class="col">
                    ...
                    <input type="" style="color:black;" class="form-control form-control-user" id="cn" name="pme" aria-describedby="" placeholder="" value="<?php echo $userdata->email_Address; ?>">
                </div>
                <div class="col">
                    ...
                    <select style="color:black;" class="custom-select lg mb-3 col-lg" aria-label=".form-select-lg example" id="rs" name="rs">
                        <?php foreach ($position as $p) : ?>
                            <option style="color:black;" value="<?php echo $p->status_Name; ?>"> <?php echo $p->status_Name; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col">
...
function kirim_email(){
   form.attr('action','<?php echo base_url('purchase/add_po_item/email'); ?>');
   form.attr('target','');
   console.log(form.attr('action'));
}

function submit_data(){
   form.attr('action','<?php echo base_url('purchase/add_po_item'); ?>');
   form.attr('target','');
   console.log(form.attr('action'));
}
