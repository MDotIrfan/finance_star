...
<body>
    ...
    <table border="1" style="width: 100%" class="table" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td style="text-align:center; background-color:green" class="bold" width="25%"><?php if($po->currency_po=='IDR'){
               echo 'Rate (IDR)';
        ...
        <?php foreach ($pi as $p) { ?>
            <tr>
                ...
                <td width="25%" style="text-align:center;">
                <?php if($po->currency_po=='IDR'&&$p->rate!=''){
                ...
                <td width="25%" style="text-align:center;">
                <?php if($po->currency_po=='IDR'&&$p->amount!=''){
