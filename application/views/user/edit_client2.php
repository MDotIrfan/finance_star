                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <?php echo form_open_multipart('user/edit_client_data2'); ?>
                                <?php foreach ($client as $c) { ?>
                                <input type="hidden" class="form-control form-control-user" id="id" name="id" aria-describedby="" placeholder="" value="<?= $c -> client_id ?>">
                                <label for="username" class="col-lg-4 col-form-label">Client Name</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="username" name="username" aria-describedby="" placeholder="" value="<?= $c -> client_name ?>">
                                </div>
                                <label for="email_address" class="col-lg-4 col-form-label">Client Email</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="email_address" name="email_address" aria-describedby="" placeholder="" value="<?= $c -> client_email ?>">
                                </div>
