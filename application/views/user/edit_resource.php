     ...
     <div class="row align-items-start">
         <div class="col">
             <ol class=" breadcrumb breadcrumb-dot justify-content-start" style="font-size: 14px;background:transparent">
                 ...
                 <li class="breadcrumb-item active justify-content-start" aria-current="page" style="color:black;">Edit Vendor</li>
             </ol>
         </div>
     </div>
     <?php echo form_open_multipart('user/edit_resource_data', 'class="form-horizontal"'); ?>
     <div class="cola" style="margin-bottom: 30px;">
         <?php foreach ($vendor as $fl) { ?>
             ...
             <div class=" justify-content-start" style="font-size: 18px; color:#939393;margin-top:30px;margin-left: 30px;margin-right: 30px;">
                 <div class="row">
                     <div class="col">
                         ...
                         <input type="" style="color:black;background: #FFFFFF;border: 1px solid #B4C9DE;box-sizing: border-box;border-radius: 7px;color:black;" class="form-control form-control-user" id="pic_name" name="pic_name" aria-describedby="" placeholder="" value="<?= $fl->pic_name ?>">
                     </div>
                     <div class=" col">
                         <label for="ps">Last Name</label>
                         <input type="" style="color:black;background: #FFFFFF;border: 1px solid #B4C9DE;box-sizing: border-box;border-radius: 7px;" class="form-control form-control-user" id="company" name="company" aria-describedby="" placeholder="" value="<?= $fl->company ?>">
                     </div>
                 </div>
             </div>
