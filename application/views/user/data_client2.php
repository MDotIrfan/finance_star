...
<div class="container-fluid">
    ...
    <div class="table-responsive">
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-3" style="width: auto;">
            ...
            <a style="margin-right: 20px;" href="<?php echo base_url('user/add_client2'); ?>"><button type="submit button" class="btn btn-success btn-add">Tambah Client</button></a>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('user/get_data_client2/client_data') ?>",
                "type": "POST"
            },
