<div class="container-fluid">
   <div style="margin-top: 20px;margin-bottom: 20px;">
      <span style="font-family: 'Franklin Gothic Medium'; font-size:22px; color:black;">INVOICE</span>
   </div>
   ...
   <form method="POST" action="<?php echo base_url('freelance/add_inv_word'); ?>">
      <?php foreach ($res as $r) : ?>
         <div class=" " style="font-size: 18px; color:#222B45;">
            <div class="row ">
               <div class="col">
         ...
         <div class=" " style="font-size: 18px;color:#222B45;color:black;">
            <div class="row">
               <div class="col">
         ...
         <div class=" " style="margin-bottom: 15px;font-size: 18px;color:#222B45;color:black;">
            <div class="row">
               <div class="col">
         ...
         <div class=" " style="border-radius: 10px;color:#222B45;">
            ...
            <div class="col-lg-9">
               <div class="row">
                  <div class="col"></div>
                  <div class="col"><a href=" <?php echo base_url('freelance/add_inv_word'); ?> "><button type="submit button" class="btn btn-success"><i class="fa fa-print" aria-hidden="true"></i>&emsp;&ensp; Save &emsp;&ensp;</button></a></div>
