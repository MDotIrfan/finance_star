            ...
            <form method="POST" action="" target="" id="myform">
                    ...
                    <div class="row ">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" style="background: #E2EFFC;color:black;" class="form-control form-control-user" id="dd" name="email" value="<?= $po->email ?>">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered shadow" style="border-radius: 10px;background-color: #FFFFFF;">
                            ...
                            <thead>
                                <tr style="color: #000000; ">
                                    ...
                                    <th><select style="color: #000000; " id="v_form" name="v_form" class="form-control font-weight-bold">
                                            <option value="0" <?php if ($po->v_form == 0) {
                                                                    echo 'selected';
                                                                } ?>>
                                                Volume
                                            </option>
                                            <option value="1" <?php if ($po->v_form == 1) {
                                                                    echo 'selected';
                                                                } ?>>
                                                Item
                                            </option>
                ...
                <div class="" style="border-radius: 10px;">
                    <div class="row">
                        ...
                        <div class="col-lg-8" style="margin-right: 80px">
...
function kirim_email(){
   form.attr('action','<?php echo base_url('freelance/edit_inv_item/email'); ?>');
   form.attr('target','');
   console.log(form.attr('action'));
}

function submit_data(){
   form.attr('action','<?php echo base_url('freelance/edit_inv_item'); ?>');
   form.attr('target','');
   console.log(form.attr('action'));
}
